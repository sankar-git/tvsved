            ...
            <ul class="nav nav-tabs">
             ...
             <!--<li><a href="#timeline" data-toggle="tab">Payment History</a></li>-->
              <li><a href="#marksheet"  data-toggle="tab">View MarkSheet</a></li>
			    <?php if($role_id=='1'){?>
              <li><a href="#attendance" data-toggle="tab">View Attendance</a></li>
			   <?php }?>
			   ...
			   <div id="courseList" class="courseList"  >
			        <div class="box-body table-responsive">
							 ...
							 <table id="example" class="table table-bordered table-hover table-striped table-condensed">
								...
								<tr id="external" class="external info">
								<th>FIRST(10)</th><th>SECOND(10)</th><th>THIRD(10)</th>
								<th>PAPER-I(60)</th><th>PAPER-II(60)</th>
								<th>PAPER-I(100)</th><th>PAPER-II(100)</th>
								</tr>
							</thead>
