        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
			  ...
			  <div class="tab-pane active" id="hallticket">
                <form class="form-horizontal" method="POST" action="<?php echo base_url();?>process/viewReport" target="fred" name="hall_ticket" id="hall_ticket">
