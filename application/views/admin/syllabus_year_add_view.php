      ...
      <div class="row">
	   ...
	   <div class="box box-primary">
            ...
            <div class="box-header with-border">
             ...
             <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="syllabus_form" id="syllabus_form" method="post" action="<?php echo base_url();?>master/saveSyllabusYear" enctype="multipart/form-data">
              <div class="box-body">
			   
			    <div class="row">
					<div class="form-group col-md-6">
					  <label for="syllabus_id">Syllabus Year<span style="color:red;font-weight: bold;">*</span></label>
