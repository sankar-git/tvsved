...
// echo "Second highest value is : " . $max2 . "<br/>";//output : 70
                ...
                $data['theory_external']    = $subject_wise_val->theory_external1+$subject_wise_val->theory_external2;
           ...
           <?php $theory_marks_40=0; for($j=1;$j<=$course_count;$j++){ $var = "theory_external".$j; $theory_marks_40+=$subject_wise_val->{$var}/5;}?>
                    ...
                    <td  align="center" style="padding:2px;"><?php echo round_two_digit($theory_marks_40);?></td>
					
          <?php $paper_20=0; for($j=1;$j<=$course_count;$j++){ $var = "theory_paper".$j; $paper_20+=$subject_wise_val->{$var}/3;}?>
                    
                    <td  align="center" style="padding:2px;"><?php echo round_two_digit($paper_20);?></td>
                    <td  align="center" style="padding:2px;"><?php echo round_two_digit($theory_internal_total+$theory_marks_40+$paper_20);?></td>
