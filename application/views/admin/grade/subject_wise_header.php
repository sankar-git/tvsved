<div align="center">
            ...
            <table style="font-size:14px;">
                ...
                <tr>
					...
					<td align="left" width="400px" style="vertical-align:top;font-weight:bold;">:&nbsp;&nbsp;<?php if(empty($students_attendance[0]->course_subject_name)) echo $students_attendance[0]->course_code; else echo $students_attendance[0]->course_subject_name;?></td>
				...
				<tr>
					...
					<td align="left" width="400px" style="vertical-align:top;font-weight:bold;">:&nbsp;&nbsp;<?php if(empty($students_attendance[0]->course_subject_title)) echo $students_attendance[0]->course_title.'('.$students_attendance[0]->theory_credit.' + '.$students_attendance[0]->practicle_credit.')'; else echo $students_attendance[0]->course_subject_title;?></td>
					<?php if(in_array($campus_id,array(1,2,3,4))){?>
                    <td align="right" width="70px" style="vertical-align:top;font-weight:bold;">Annual Board</td>
