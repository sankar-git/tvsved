...
<!-- <div align="center">
            ...
            <table width="100%" style="font-size:14px;">
                ...
                <tr>
					...
					<td align="left"  style="vertical-align:top;">:&nbsp;&nbsp;<?php echo $students_attendance[0]->semester_name.'-'.'Annual';?><!-- <?php if(empty($students_attendance[0]->course_subject_name)) echo $students_attendance[0]->course_code; else echo $students_attendance[0]->course_subject_name;?> (<?php echo $students_attendance[0]->theory_credit.'+'.$students_attendance[0]->practicle_credit;?>) --></td>
