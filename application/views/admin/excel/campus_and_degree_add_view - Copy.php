    ...
    <section class="content">
      ...
      <div class="row">
	   ...
	   <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="campus_and_degree_form" id="campus_and_degree_form" method="post" action="<?php echo base_url();?>campus/saveCampusDegree" enctype="multipart/form-data">
