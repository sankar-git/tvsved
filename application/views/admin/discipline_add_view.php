      ...
      <div class="row">
	   ...
	   <div class="box box-primary">
            ...
            <div class="box-header with-border">
             ...
             <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="discipline_form" id="discipline_form" method="post" action="<?php echo base_url();?>discipline/saveDiscipline" enctype="multipart/form-data">
              <div class="box-body">
			    <div class="row">
					<div class="form-group col-md-4">
					  <label for="discipline_code">Discipline Code<span style="color:red;font-weight: bold;">*</span></label>
					  <input type="text" class="form-control" id="discipline_code" name="discipline_code" placeholder="Enter Discipline">
					</div>
					<div class="form-group col-md-4">
					  <label for="discipline_name">Discipline Name<span style="color:red;font-weight: bold;">*</span></label>
					  <input type="text" class="form-control" id="discipline_name" name="discipline_name" placeholder="Enter Discipline Name">
					</div>
					<div class="form-group col-md-4">
