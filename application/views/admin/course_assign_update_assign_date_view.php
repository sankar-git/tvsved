 ...
 color:red;	
    ...
    <section class="content">
      ...
      <div class="row">
	   ...
	   <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="course_assign" id="course_assign" method="post" action="<?php echo base_url();?>course/updateCourseDateAssign/<?php echo $course_assign_row->id;?>" enctype="multipart/form-data">
              <div class="box-body">
			    <div class="row">
			    ...
			    <div class="row">
					<div class="form-group col-md-3">
					  ...
					  <input type="text" class="form-control" id="start_date" name="start_date" value="<?php echo $course_assign_row->start_date;?>" placeholder="mm-dd-yyyy">
					</div>
					<div class="form-group col-md-3">
					  <label for="exampleInputEmail1">Date Of Closure<span style="color:red;font-weight: bold;">*</span></label>
					 <input type="text" class="form-control" id="date_of_closure" name="date_of_closure" value="<?php echo $course_assign_row->date_of_closure;?>" placeholder="mm-dd-yyyy">
					</div>
				</div>	
  ...
  <script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#date_of_closure").datepicker({format: 'dd-mm-yyyy',autoclose: true});
