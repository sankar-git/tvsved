      ...
      <div class="row">
	   ...
	   <div class="box box-primary">
            ...
            <div class="box-header with-border">
             ...
             <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="batch_form" id="batch_form" method="post" action="<?php echo base_url();?>batch/saveBatch" enctype="multipart/form-data">
              <div class="box-body">
			    <div class="row">
				    <div class="form-group col-md-3">
					  ...
					  <option value="<?php echo $syllaus_value->id;?>"><?php echo $syllaus_value->syllabus_year;?></option>
					  <?php }?>				 
					  </select>
					</div>
					<div class="form-group col-md-3">
					  <label for="degree_code">Batch Start Year<span style="color:red;font-weight: bold;">*</span></label>
					  <input type="text" class="form-control" id="batch_start_year" name="batch_start_year" placeholder="Enter Batch Start Year">
					</div>
					<div class="form-group col-md-3">
