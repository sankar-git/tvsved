              ...
              <div class="box-body">
			    ...
			    <div class="row">
					...
					<div class="form-group col-md-3">
					  ...
					  <input type="text" class="form-control" id="course_code" name="course_code" value="<?php echo $course_row->course_code?>" placeholder="Enter Course Code">
					</div>
					<div class="form-group col-md-3">
					  <label for="course_title">Course Title.<span style="color:red;font-weight: bold;">*</span></label>
					  <input type="text" class="form-control" id="course_title" name="course_title" value="<?php echo $course_row->course_title;?>" placeholder="Enter Course Title">
					</div>
			    ...
			    <div class="row">
				    <div class="form-group col-md-3">
					  ...
					  <input type="text" class="form-control" id="theory_credit" name="theory_credit" value="<?php echo $course_row->theory_credit;?>" placeholder="Enter Theory Credits">
					</div>
					<div class="form-group col-md-3">
					  <label for="practicle_credit">Practicle Credits.<span style="color:red;font-weight: bold;">*</span></label>
					  <input type="text" class="form-control" id="practicle_credit" name="practicle_credit" value="<?php echo $course_row->practicle_credit?>" placeholder="Enter Practicle Credits">
					</div>
					<div class="form-group col-md-3">
