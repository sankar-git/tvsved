		...
		<div class="row clearfix">
			...
			<div class="col-lg-4 col-md-7 col-xs-12">
				<div class="card locked">
                    ...
                    <form class="col-md-12" id="authenticate" name="authenticate" method="post" action="<?php echo base_url();?>authenticate/junior_login" autocomplete="false" onsubmit="return checkValidation();">
