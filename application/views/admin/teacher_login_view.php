		...
		<div class="row clearfix">
                ...
                <div class="l-detail">
							...
							<div class="row">                    
								<div class="col-xs-12">
									...
									<a href="<?php echo base_url();?>authenticate/teacherLogin" class="btn btn-raised waves-effect bg-white" name="go" type="submit">Teacher Login</a>
			...
			<div class="col-lg-4 col-md-7 col-xs-12">
				<div class="card locked">
                    ...
                    <form class="col-md-12" id="authenticate" name="authenticate" method="post" action="<?php echo base_url();?>authenticate/teacher_login" autocomplete="false" onsubmit="return checkValidation();">
