      ...
      <div class="row">
	   ...
	   <div class="box box-primary">
            ...
            <div class="box-header with-border">
             ...
             <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="permission_form" id="permission_form" method="post" action="<?php echo base_url();?>permissions/savePermissions" enctype="multipart/form-data">
              <div class="box-body">
			    <div class="row">
					...
					<div class="form-group col-md-6">
					  ...
					  <select name="user_id" id="user_id" class="form-control" onchange="permitted_page(this.value);">
			    ...
			    <div class="row">
				 <label class="box-header">Permision Details List</label>
