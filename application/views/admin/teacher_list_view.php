									...
									<td>
										...
										<div class="btn-group outer">
											...
											<!-- <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>admin/deleteUser/<?php echo $users->uid.'/2'; ?>" onclick="return areyousure();" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i> </a>-->
											 ...
											 <a class="btn btn-sm btn-primary inner" href="<?php echo base_url(); ?>admin/userDetails/<?php echo $users->uid.'/'.$users->status; ?>" title="View Detail" data-toggle="tooltip"><!-- <i class="fa fa-eye"></i> -->View Details</a>
