...
.error{
 color:red;	
				...
				<div class="row">
				  ...
				  <div class="row">
					...
					<div class="form-group col-md-4">
					  ...
					  <select name="course_id[]" id="course_id" class="mdb-select form-control" multiple>
				   ...
				   <div class="row">
					<div class="form-group col-md-4">
					  ...
					  <select name="status_id" id="status_id" class="form-control" onchange="getStudentWithCourse(this.value);">
  ...
  <script type="text/javascript">
	...
	function uploadedNotuploaded(status)
	{
		if(status==1)
		{
