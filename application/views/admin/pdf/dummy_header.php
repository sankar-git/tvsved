<table  width="100%">
                <tr>
					...
					<table width="100%">
								...
								<tr>
                                    <td align="center">
									<p align="center" style=" font-size:13px; font-weight:bold;"><?php echo $dummy_number_report[0]['semester_name'];?>&nbsp;<?php echo $dummy_number_report[0]['degree_code'];?>&nbsp;Degree Dummy Number Report</p>
           ...
           <table width="100%" style="font-size:13px;padding:0px;" >
				...
				<tr>
					...
					<td align="left" width="300px" style="vertical-align:top;font-weight:bold;">:&nbsp;&nbsp;<?php echo $dummy_number_report[0]['campus_code'];?></td>					
