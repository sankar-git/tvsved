           ...
           <div class="box-footer" >
               <p style="color:green" align="center"> <?php echo $this->session->flashdata('message'); ?></p>
				 ...
				 <div style="float:right;">
				  <a class="btn btn-primary " href="<?php echo site_url('campus/campusAndDegreeAdd'); ?>"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp; Add Campus & Degree</a>
				</div>
          </div>
            <div class="box-body table-responsive">
							 ...
							 <table id="example" class="table dataTable no-footer" cellspacing="0">
								...
								<tr>
									...
									<?php $i=0;foreach ($campus_and_degree_list as $campuses): $i++;?>
									<tr>
									
									<td><?php echo $i; ?></td>
									<td><?php echo $campuses->campus_name;?></td>
									<td><?php echo $campuses->program_name;?></td>
									<td><?php echo $campuses->degree_name;?></td>
									...
									<td>
										<div class="btn-group" style="width:180px;display: flex !important;">
											<a class="btn btn-sm btn-info" style="margin-right: 6px" href="<?php echo site_url('campus/campusAndDegreeEdit/'.$campuses->caid);?>" title="Edit" data-toggle="tooltip"><!-- <i class="fa fa-pencil"></i> -->Edit</a>
						
											<!-- <a class="btn btn-sm btn-danger" href="<?php echo site_url('campus/deleteCampusDegree/'.$campuses->caid);?>" onclick="return areyousure();" title="Delete" data-toggle="tooltip"><i class="fa fa-trash-o"></i> </a>-->

											 <a class="btn btn-sm btn-primary" style="margin-right: 6px" href="<?php echo site_url('campus/detailCampusDegree/'.$campuses->caid);?>" title="View Detail" data-toggle="tooltip"><!-- <i class="fa fa-eye"></i> -->View Details</a>
											 
											 <a class="btn btn-sm <?php echo $btnClass; ?>" href="<?php echo base_url(); ?>campus/campusDegreeStatus/<?php echo $campuses->caid.'/'.$campuses->status; ?>" title="<?php echo $title; ?>" data-toggle="tooltip"><i class="fa fa-undo"></i><?php if($campuses->status=='1') { ?> Active<?php }else { ?> Inactive<?php } ?></a>
										</div>
									</td>
									</tr>
									<?php endforeach;?>
