              ...
              <div class="box-body">
			    <div class="row">
					<div class="form-group col-md-3">
					  <label for="program">College<span style="color:red;font-weight: bold;">*</span></label>
					...
					<div class="form-group col-md-3">
					  <label for="exampleInputEmail1">Annual Board<span style="color:red;font-weight: bold;">*</span></label>
			    ...
			    <div class="row">
					<div class="form-group col-md-3">
					  <label for="course-group">Month<span style="color:red;font-weight: bold;">*</span></label>
