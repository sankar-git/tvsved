                                ...
                                <tr>
                                    <td>
                                        <div>
                                            ...
                                            <p align="center" style=" font-size:18px; font-weight:bold;"><?php echo $student_val['semester_name']?></p>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div id="Divmain">
                <table style="font-size:14px;">
                    ...
                    <tr>
                        <td>
                         <div>
                            <b>ID. No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : </b><?php echo $student_val['user_unique_id']; ?>
						 </div>
						</td>
                    ...
                    <tr>
                        ...
                        <td><div><b>Semester &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</b> <?php echo $student_val['semester_name']; ?></div></td>
                    </tr>
                </table>
                <br />
                ...
                <tr>
                    ...
                    <td><?php if(!empty($student_course['internal_sum'])) {echo $student_course['internal_sum'];}else{
													  echo 'N/A';}
												   ?></td>
