    ...
    <div >
       <table id="table" width="100%">
                ...
                <tr>
                    ...
                    <!--  <td><?php echo $teacherObj->parent_name;?></td>
                    <td><?php echo $teacherObj->mother_name;?></td>
                    <td><?php echo $teacherObj->occupation;?></td>
                    <td><?php echo $teacherObj->father_contact;?></td>
                    <td><?php echo $teacherObj->alternate_contact;?></td>
