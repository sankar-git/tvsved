...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url();?>assets/admin/index2.html"><b>Admin</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg"><?php echo validation_errors(); ?> 
                        <?php echo $this->session->flashdata('logoutmsg'); ?></p>

    <?php echo form_open('authenticate/user_login', array('id' => 'authenticate')); ?>
