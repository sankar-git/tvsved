...
class Marks extends CI_Controller {
		...
		$trdata='';
			...
			{ 
				...
				$trdata.='<tr>
							...
							<td><input type="text" name="theory_internal1[]" value="'.$students->theory_internal1.'" style="width:60px;">
							    <input type="text" name="theory_internal2[]" value="'.$students->theory_internal2.'" style="width:60px;">
								<input type="text" name="theory_internal3[]" value="'.$students->theory_internal3.'" style="width:60px;">
							
							</td>
							<td><input type="text" name="theory_paper1[]" value="'.$students->theory_paper1.'" style="width:80px;">
							    <input type="text" name="theory_paper2[]" value="'.$students->theory_paper2.'" style="width:80px;">
							</td>
				...
				$trdata.='<tr>
						  ...
						  <td>'.$students->first_name.' '.$students->last_name.'</td>
						  <td>
						  <input type="text" name="theory_internal[]" value="'.$students->theory_internal1.'" '.$readonly.' style="width:60px;">
						  <input type="text" name="theory_interna2[]" value="'.$students->theory_internal2.'" '.$readonly.' style="width:60px;">
						  <input type="text" name="theory_interna3[]" value="'.$students->theory_internal3.'" '.$readonly.' style="width:60px;">
						  </td>
						  <td>
						  <input type="text" name="theory_paper1[]" value="'.$students->theory_paper1.'" '.$readonly.' style="width:80px;">
						  <input type="text" name="theory_paper2[]" value="'.$students->theory_paper2.'" '.$readonly.' style="width:80px;">
						  </td>
						  <td><input type="text" name="theory_external[]" value="'.$students->theory_external.'" style="width:80px;">
						      <input type="text" name="practical_external[]" value="'.$students->practical_external.'" style="width:80px;">
						  </td>
			...
			foreach($studentListNew as $students)
			{
				...
				$trdata.='<tr>
				        <td><input type="hidden"  value="'.$students->user_unique_id.'">'.$students->user_unique_id.'
				          ...
				          <td>'.$students->first_name.' '.$students->last_name.'</td>
						  <td class="two">
						     <input type="text" name="theory_internal1[]" id="theory_internal1" value="" style="width:60px;" >
						     <input type="text" name="theory_internal2[]" id="theory_internal2" value="" style="width:60px;">
						     <input type="text" name="theory_internal3[]" id="theory_internal3" value="" style="width:60px;" onkeyup="getInternal('.$students->id.')" >
						     
						  </td>
						  <td><input type="text" name="theory_paper1[]" value="" style="width:80px;">
							    <input type="text" name="theory_paper2[]" value="" style="width:80px;">
						  </td>
				...
				$trdata.='<tr>
						...
						<td>'.$students->first_name.' '.$students->last_name.'</td>
						  <td>
						      <input type="text" name="theory_internal1[]" value="'.$students->theory_internal1.'" '.$readonly.' style="width:60px;" >
						      <input type="text" name="theory_internal2[]" value="'.$students->theory_internal2.'" '.$readonly.' style="width:60px;" >
						      <input type="text" name="theory_internal3[]" value="'.$students->theory_internal3.'" '.$readonly.' style="width:60px;" >
						  </td>
						  <td>
						      <input type="text" name="theory_paper1[]" value="'.$students->theory_paper1.'" '.$readonly.' style="width:80px;" >
						      <input type="text" name="theory_paper2[]" value="'.$students->theory_paper2.'" '.$readonly.' style="width:80px;" >
						  </td>
						  <td><input type="text" name="theory_external[]" value="" style="width:80px;">
						      <input type="text" name="practical_external[]" value="" style="width:80px;">
						  </td>
				...
				$trdata.='<tr>
				         <td><input type="hidden"  value="'.$students->user_unique_id.'">'.$students->user_unique_id.'
						  ...
						  <td>'.$students->first_name.' '.$students->last_name.'</td>
						  <td>
						     <input type="text" name="theory_internal111[]" value="" '.$readonly.' style="width:60px;" >
						     <input type="text" name="theory_internal222[]" value="" '.$readonly.' style="width:60px;" >
						     <input type="text" name="theory_internal333[]" value="" '.$readonly.' style="width:60px;" >
						  </td>
						  <td>
						    <input type="text" name="theory_paper111[]" value="" '.$readonly.' style="width:80px;" >
						    <input type="text" name="theory_paper222[]" value="" '.$readonly.' style="width:80px;" >
						  </td>
						  <td><input type="text" name="theory_external1[]" value="" '.$readonly.' style="width:80px;">
						      <input type="text" name="practical_external1[]" value="" '.$readonly.' style="width:80px;">
						  </td>
	...
	function saveUGInternalMarksNew()
	{
		...
		$theory_external=$this->input->post('theory_external');  // 100
	...
	if($marks_type=='2'){
		...
		//echo "hello"; exit;
				...
				for($j=0;$j<count($student_ids);$j++){
						$student_id=$student_ids[$j];
						//$theory_marks11=$theory_internal1[$i];
						//p($theory_marks11); exit;
						//p($theory_marks1); exit;
						//$theory_marks2=$theory_internal2[$i];
						//$theory_marks3=$theory_internal3[$i];
						 $theory_paper1_marks=$theory_paper1[$j];
                         $theory_paper2_marks=$theory_paper2[$j];
						 $theory_external_marks=$theory_external[$j];
						 $practical_external_marks=$practical_external[$j];
						...
						$data2 = array(
							...
							//'theory_internal2'=>$theory_marks2,
							//'theory_internal3'=>$theory_marks3,
							'theory_paper1'=>($theory_paper1_marks) ? $theory_paper1_marks:'',//PRACTICAL
							'theory_paper2'=>($theory_paper2_marks) ? $theory_paper2_marks:'', //PRACTICAL
							//'sum_internal_practical'=>$sum_get_internal_practical, //total_sum_internal_practical
							
							'theory_external'=>($theory_external_marks) ? $theory_external_marks:'', //100
							'practical_external'=>($practical_external_marks) ? $practical_external_marks:'', //100
							'external_sum'=>($external_sum) ? $external_sum:'',
