...
class Provisional extends CI_Controller {
	...
	function generateProvisional()
	{
		
		 //*************************Generate student Transcript*********************************//
		 if(!empty($this->input->post('provisional_result')))
		 {  
			...
			$html=$this->load->view('admin/report/student_bvsc_result_provisional', $data, true);
			// print_r($html); exit;
			//this the the PDF filename that user will get to download
			$pdfFilePath = "profisional_report.pdf";
	 
			//load mPDF library
			$this->load->library('m_pdf');
			$this->m_pdf->pdf->setTitle('Provisional Report');
		...
		$data['page_title']="Generate Student Provisional Report";
		...
		$this->load->view('admin/generate_student_provisional_result_view',$data);
