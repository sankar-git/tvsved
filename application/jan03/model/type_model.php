...
{	
	...
	function list_user()
	{
		return $this->db->order_by('first_name', 'ASC')->where('role_id !=', 0)->get('users')->result();//method chaining
	}
	...
	function list_student()
	{
		...
		$this->db->join('student_assigned_courses as s','s.student_id = u.id','LEFT');
		$this->db->where('u.role_id', 1);
		if($_POST['campus_id'] != '' && $_POST['campus_id'] != '0')
		...
		if($_POST['discipline_id'] != '' && $_POST['discipline_id'] != '0')
