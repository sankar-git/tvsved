...
class TransactionRequest
{
	...
	public function setLoginUser($login_user_id)
    {
     ...
     * @return the $customerMobile
     */
    public function getCustomerSemester()
    {
        return isset($this->semester_id)?$this->semester_id:0;
    }
	/**
     * @return the $customerMobile
     */
    public function getCustomerProgram()
    {
        return isset($this->program_id)?$this->program_id:0;
    }
     ...
     * @param string $customerMobile
     */
    public function setCustomerSemester($semester_id)
    {
     ...
     * @param string $customerMobile
     */
    public function setCustomerProgram($program_id)
    {
	...
	public function getChecksum(){
       ...
       // echo $str;exit;
        ...
        private function getData(){
			...
			$saveTransaction['user_name']=$this->getLogin();
			$saveTransaction['user_password']=$this->getPassword();
			$saveTransaction['product_id']=$this->getProductId();
			$saveTransaction['currency']=$this->getTransactionCurrency();
			$saveTransaction['amount']=$this->getTransactionAmount();
			$saveTransaction['clientcode']=$this->getClientCode();
			$saveTransaction['transaction_id']=$this->getTransactionId();
			$saveTransaction['date']=$this->getTransactionDate();
			$saveTransaction['customer_name']=$this->getCustomerName();
			$saveTransaction['customer_email']=$this->getCustomerEmailId();
			$saveTransaction['customer_mobile']=$this->getCustomerMobile();
			$saveTransaction['customer_billing_address']=$this->getCustomerBillingAddress();
			$saveTransaction['customer_account']=$this->getCustomerAccount();
			$saveTransaction['login_user_id']=$this->setLoginUser();
			$saveTransaction['semester_id']=$this->getCustomerSemester();
			$saveTransaction['program_id']=$this->getCustomerProgram();
			$saveTransaction['payment_type']=$this->getPaymentType();
			$saveTransaction['signature']=$this->getChecksum();
			
			//p($saveTransaction); exit;
			 $CI =& get_instance();
			$recor = $CI->Payment_model->save_user_payment_info($saveTransaction);
